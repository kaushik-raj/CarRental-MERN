...
const App = () => {
  ...
  return (
    <>
    {/* So that we can use toaster in each components . */}
     <Toaster />
     {/* when the showLogin state variable is true , them simply show the login component . */}
      {showLogin && <Login/>}
    ...
    <Routes>
      ...
      {/* Here we are using nested routes to create the Owners pages  */}
