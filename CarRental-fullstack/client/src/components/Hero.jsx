...
const Hero = () => {
    ...
    // here we are defining a function to handle the search functionality
    // This function will be called when the user submits the search form
    // It will navigate to the cars page with the selected pickup location and dates as query parameters
    // This will allow the Cars page to filter the cars based on the selected location and dates
